...
public sealed class LandingPadTests : IDisposable
{
    ...
    {
        _root = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "spacecraft_pad_" + Guid.NewGuid().ToString("N"));
    ...
    public void WhenEveryPadIsTaken_TheBodyIsFull_AndLandingIsRefused()
    {
        ...
        var holders = new List<Spacecraft.GameServer.PlayerSession>();
