...
namespace Spacecraft.Client
{
    ...
    /// <c>Spacecraft/Visor</c> pass — a cyan rim glow, faint animated scanlines and a top glass glint — but
    ...
    public sealed class VisorMenuGlass : MonoBehaviour
    {
        ...
        public static void Add(Transform menuRoot)
        {
            ...
            var shader = Shader.Find("Spacecraft/VisorGlass");
            if (shader == null)
            {
                Debug.LogWarning("[VisorMenuGlass] Spacecraft/VisorGlass shader not found; menu stays flat.");
                return;
            }
