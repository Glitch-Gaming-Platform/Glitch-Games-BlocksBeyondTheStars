...
namespace Spacecraft.Client
{
    ...
    public static class UiMainMenu
    {
        public static GameObject Build(AppShell shell)
        {
            ...
            // --- Menu buttons ---
            const float bx = 90f, bw = 440f, bh = 48f, gap = 56f;
            float by = 300f;
            ...
            UiKit.AddButton(root, bx, by + gap * 4f, bw, bh, shell.L("ui.menu.station_editor"), shell.OpenStationEditor, "btn_singleplayer");
            UiKit.AddButton(root, bx, by + gap * 5f, bw, bh, shell.L("ui.menu.settlement_editor"), shell.OpenSettlementEditor, "btn_singleplayer");
            UiKit.AddButton(root, bx, by + gap * 6f, bw, bh, shell.L("ui.menu.settings"), shell.OpenSettings, "btn_settings");
            UiKit.AddButton(root, bx, by + gap * 7f, bw, bh, shell.L("ui.menu.credits"), () => shell.GoTo(ShellPhase.Credits), "btn_credits");
            UiKit.AddButton(root, bx, by + gap * 8f, bw, bh, shell.L("ui.menu.quit"), shell.Quit, "btn_exit");
