...
namespace Spacecraft.Client
{
    ...
    /// <c>Spacecraft/SunGlow</c> shader draws additively with ZTest Always), gently pulsing and fading out
    ...
    public sealed class OreScanView : MonoBehaviour
    {
        ...
        private void OnScan(OreScanResult scan)
        {
            ...
            _glow ??= Shader.Find("Spacecraft/SunGlow") ?? Shader.Find("Unlit/Color");
        ...
        {
            string key = Game?.Content?.BlockById(new Spacecraft.Shared.Primitives.BlockId(blockId))?.Key ?? string.Empty;
