...
- **⏭ Open:** **SSR** (screen-space reflections on water/metal/hull) — the last big one, a full-screen renderer feature, highest risk/iteration. Plus minor: **warp** VFX (already a clean UI effect, low ROI), **weather** VFX deliberately kept (WeatherFx3D is world-aware — particles would regress cave/roof behaviour), URP decals.
